    ...
    <>
      <div className="container text-center max-w-[1070px] mx-auto relative">
        ...
        <div className="lg:flex lg:flex-row-reverse lg:absolute top-1/2 right-0  lg:-translate-y-1/2 max-w-[900px]  lg:text-white">
          <img className="w-[300px] mx-auto" src="/home/MENA-INFLUENCERS.png" alt="" />
          <div className="">
            ...
            <p className="paragraph">
              ...
              Specialists And Media Experts that Will Help your Company and Support
              Your Brand from Defining KPIs, Goals And Needs, Passing By influencers
              Identification And Storytelling, To Campaign Execution, Tracking and
              Reporting.
            </p>
          </div>
        </div>
