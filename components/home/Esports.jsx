...
export default function Esports(props) {
  return (
    <>
      ...
      <img className="absolute animate-spin-slow top-5 left-[-55px] -z-10"  src="/objects/blue-square.png" alt=""  />
        ...
        <div className="lg:grid lg:grid-cols-2 lg:absolute lg:top-1/2 lg:left-0 lg:-translate-y-1/2 max-w-[900px]">
          <div className="">
            <img className="mx-auto lg:w-[361px]" src="/home/escort-img-mobile.png" alt="" />
          </div>
          <div className="">
